...
この [erpimage.m](http://sccn.ucsd.edu/eeglab/locatefile.php?file=erpimage.m) 関数は以下のパラメータによって制御されます。
...
ウィンドウ内で一定です。このレイテンシウィンドウは、すべての試験で定数です。 0 の値は
