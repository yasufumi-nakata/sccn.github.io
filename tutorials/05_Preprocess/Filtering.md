...
バンドストップフィルタでラインノイズを除去することもできますが、[CleanLine](https://github.com/sccn/cleanline) EEGLABプラグインは、様々なテーパリングとトンプソンF統計を組み合わせたより効率的なソリューションを提供します。CleanLineは [EEG-Clean-Tools](https://github.com/VisLab/EEG-Clean-Tools) にも含まれています。以下の比較図に示すように、このメソッドが適切に動作する場合、結果は顕著です。
