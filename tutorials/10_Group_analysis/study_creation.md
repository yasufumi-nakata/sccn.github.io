...
同じタスクまたは異なるタスクの実行
STUDY*の学習、実験的研究の専攻、研究をまとめます。 チュートリアルでは、EEGLAB(Youtubeでホスト) の処理をしています。
...
このチュートリアルでは、 [5被験者データセット](http://sccn.ucsd.edu/eeglab/download/STUDY5subjects.zip) (450Mb) Peter Ullsberger と 5 件のフィードバックを投稿しました。
...
ここでは、メモを書いていません。
勉強しますが、自分の研究のためにそうすることをお勧めします。蓄積されたメモは、研究で常に読み込まれ、後で増加します
...
STUDYの部分。各データセット、被験者コードを指定します。
条件名。
- これらは、以下のとおりです。 実験のブロックで、各ブロックのデータが別々のファイルに保存されている場合、STUDYでは各セッションのデータを統合して解析できます。
- *条件* - 被験者のファイルとEEGLABイベントを組み合わせて解析できます。詳細は [チュートリアル](/tutorials/10_Group_analysis/working_with_study_designs.html).
...
をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて をすべて

Ok* は、 [pop_study](http://sccn.ucsd.edu/eeglab/locatefile.php?file=pop_study.m) すべてのデータセットをインポートする

EEGLABに読み込まれます。 メニュー項目 <span style="color: brown">ファイル → 学習をそのまま保存する</span> 閉鎖の後で [pop_study](http://sccn.ucsd.edu/eeglab/locatefile.php?file=pop_study.m) ウィンドウ。
