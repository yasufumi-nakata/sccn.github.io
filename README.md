...
ライブページ: https://yasufumi-nakata.github.io/sccn.github.io
...
* 画像は保存されます [アセット・イメージ](https://github.com/yasufumi-nakata/sccn.github.io/tree/main/assets/images)お問い合わせ アップロードした画像をページ内でリンクするには、パス "/assets/images/<image_filename>"
...
* リポジトリをクローンする: ``git clone https://github.com/yasufumi-nakata/sccn.github.io.git; cd sccn.github.io``
