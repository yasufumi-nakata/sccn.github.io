...
2. ウェブから: プラグイン* nsgportal*のコンテンツでzipファイルをダウンロードする [GitHubで](https://github.com/sccn/nsgportal) ページ(GithubでZipをダウンロード)またはEEGLAB wikiページからプラグインを選択 [詳しくはこちら](https://sccn.ucsd.edu/wiki/Plugin_list_all)を参照 フォルダ*./eeglab/plugins*でzipファイルを解凍し、EEGLABを再起動します。
