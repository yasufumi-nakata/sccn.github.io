...
nav_title: "EEGLABプラグインでpop_nsgコマンドラインツールを使う"
...
次のセクションでは、これらの手順を詳細に説明します。 サブセクション見出しはコメント見出しに直接参照されます [pop_icansg.m](https://github.com/sccn/nsgportal/blob/master/demos/demo_plugin/icansg/pop_icansg.m).
