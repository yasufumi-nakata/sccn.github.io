...
残りのチャンネル/コンポーネントをすべてクリーニングする前にオフ。 注:PlotFiguresが*considerably遅い*ならCleanLineは*です
...
広さ amps{i})
  ...
  **g**** 変数構造。 関数呼び出しは、呼び出しで正確にレプリカすることができます >> CleanLine(EEG、g);
