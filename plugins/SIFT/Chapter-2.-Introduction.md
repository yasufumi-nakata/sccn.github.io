...
機能的コネクティビティ解析の代表的な例として、機能的磁気共鳴画像法(fMRI)では、多数の被験者におけるBOLD活動について、脳内の関心ボクセルまたは関心領域間の相関(または偏相関)を計算します。
...
テーブルのキャプション。 granger-causal用の無料のMATLABベースのツールボックスのリスト
神経データの接続解析
...
SIFTはオープンソースのMATLAB(Mathworks, Inc.)の解析ツールボックスです。
多様な情報の流れと因性を可視化し、
