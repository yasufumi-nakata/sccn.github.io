...
Vieira-Morf は、わずかに優れた係数推定値を返します。
...
|---------------------------|-----------------|
| オプション | バリュー |
| **MVARアルゴリズムを選択してください** | **Vieira-Morf ** |
|****************************
| **ステップサイズ(秒)** | **0.01** |
|****************************************
| マンション** |
...
`pop_est_validateMVAR()` ここでは、ホワイトネスのホワイトネスを確認するために選ぶことができます
...
より保守的な)ほとんどのウィンドウが白であることを示します。エポックの端付近の窓の範囲が異常に失敗するという事実
...
または 0 近くでは、不安定な (およびおそらく非静止) モデルを示します。
