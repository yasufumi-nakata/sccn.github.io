...
著者:ルカ・ピオン・トナチーニ、ミヤコシマコト。 SCCN、INC、UCSD。 チルド・ダイポール・プロット(mir3dplot)を示す機能はArnaud Delormeによって書かれました。
...
[詳しくはこちら](http://www.talairach.org/labels.html)を参照 能力について
Level3(名)とLevel5(Brodmann)は、
別に計算されるので、EACHの確率の合計は1です。
