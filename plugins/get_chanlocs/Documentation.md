...
<b>主な利点</b> 使用方法 <em>get_chanlocs</em> 測定する
電極の位置はそれです: 1) <b>3D画像はすぐに録画できます
(\<1 min)</b>、それによって貴重な被験者の時間(および注意を節約して下さい
容量) EEGデータを記録するために使用されるよりよい! 過去の研究者
最も熱心に耳を傾ける <em>get_chanlocs</em>
...
実際の被験者の頭部にテンプレートヘッドモデルを warp。 3) と違って
...
マシンビジョンのアプローチで未来のところにある。電極のラベルおよび3-Dの位置は3頭に相対的に置きます
...
詳しくはこちら 被験者 MR ヘッドイメージが *not* の場合
...
この問題を回避するための1つの方法は、3D図の回転ツールを使用することです
