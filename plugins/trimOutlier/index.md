...
![400px\|図 1. 初期化されるトリムアウトイヤー](images/To1.png)
...
![400px\|図S1。 更新された表示](images/additional.jpg)
...
プロセスは下限に基づいて除去のために起こります。 境界線を下回る
...
除去が満足していない場合。 プロセスの最終決定

![400px\]|図 4.入力のthrehsoldおよびポイントに基づくデータポイントの除去
