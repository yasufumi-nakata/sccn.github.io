...
最初のインストール [オタク](https://www.gnu.org/software/octave/download.html) パソコンで バージョン4.4以降を推奨します。 次に示すようにOct2pyとMNEライブラリをインストールします。 それから、[MFFMatlabIO リポジトリ](https://github.com/sccn/mffmatlabio)を参照し、任意の MFF テストファイルを準備して解凍して下さい。
