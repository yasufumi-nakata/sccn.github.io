...
![](400px-NFT_from_MRI_segmentation.png) .....
...
画像。 値が増加するにつれて、画像は鈍化し始めます。「フィルター」を選択することで、異方性フィルタリングの出力を観察できます。
...
![図7: 目元をクリックするMATLAB図。](NFT_eyelobes.png "wikilink")
...
MATLAB形式で保存され、名前は2つの優先度で保存されます。
...
メインメニューで選択した被験者名と被験者フォルダを使用します
分割ファイルの場合。 出力フォルダは Subject フォルダーに設定されます。
被験者名にメッシュ名を設定します。 変更可能
...
この目的のために、3つの外部プログラムとさまざまなMATLAB関数
...
隣接するメッシュは、ユーザが指定したLMR比で多岐に渡ります。
...
![](NFT_sourcespacegen.png "wikilink") .....
...
![](NFT_coregistration.png "wikilink") ....
