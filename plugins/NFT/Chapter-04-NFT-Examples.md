...
サンプルは同じ被験者を使用します。 最初の例は現実的を生成します
被験者のMR画像を用いたヘッドモデル。 第2の例は警戒します
...
2 番目の例では、利用可能な被験者データのみが利用できると仮定します。
141桁の電極の位置。 テンプレートMNIメッシュを歪めるために
3 つの層および 3000 ノードおよび 5988 要素を持つ使用される。
...
表3は、被験者名がいるときに出力フォルダの内容を表示します
コンテンツ Aとセッション名は、テーブル1で指定した例のセッション1です。
表4は、被験者の名前がない場合、表2で指定された場合に示します。
...
| 演題募集 | 939 MB |
| ソーススペース | 581 KB |
| セッション1|被験者A|ヘッドセンサー|6.9 KB |
| セッション1_被験者A_センサーインデックス_ | 2.2 KB |
| セッション1.セッション | 4.8 KB |
| セッション1.tmte | 53.9MB |
...
| 件名B.imt | 46.3 MB |
| ソーススペース | 959 KB |
| セッション1|被験者B|ヘッドセンサー|6.4 KB |
| セッション1_被験者B_センサーインデックス_ | 2.1 KB |
| セッション1.セッション | 7.6 KB |
| セッション1.tmte | 32.7 MB |
