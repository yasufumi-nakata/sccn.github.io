...
**剪定された単一被験者データセットをダウンロード (ds000117_pruned):**
...
* **Session_5.2_univariate_statistics_practicum.pptx** – モデルの仕様と補正を含む複数の被験者データセットで完全なGLM解析を実行します。
