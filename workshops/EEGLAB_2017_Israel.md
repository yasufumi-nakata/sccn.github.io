...
![350px\|thumb\|right\|upright=2.5\|【公式】 外門、井戸、タマリスク
Tel Beershebaのツリー:(/assets/images/Xxx.png)

第20回 EEGLABワークショップ
============================

<span style="color: blue">Ben-Gurion University/ビール-Sheva、イスラエル - 10月
15-18, 2017</span>
第26回EEGLABワークショップが10月15日(日)に開催されます
10月18日(金)からBen-Gurion University/ Beer-Shevaにてビール醸造。
ノートパソコンをMATLABにインストールすると参加者が期待されます。
実践的なセッションに参加できるようにします。 チュートリアル
ワークショップでは、EEGLABソフトウェアの使用について紹介し、実証します
環境と EEGLAB のリンクツール 高度な分析を実行するための
EEGおよび関連データ、詳細な方法の博覧会および実用的
練習。
...
<u><span style="color: blue">10月15日(日)</span></u>
...
<span style="color: orange">14:00～14:30～ データのインポート、アーティファクト拒否...続き(John Iversen)</span>
...
<span style="color: purple">17:30～19:30～ ポスターセッション</span>
...
<u><span style="color: blue">10月16日(月)</span></u>


**EEGLABのグループ分析とICAクラスタリング* * 必須


<span style="color: purple">8:45～9:15～ なぜクラスターICAコンポーネント? (Scott Makeig)</span> [PDF](https://sccn.ucsd.edu/githubwiki/files/makeig_eeglab_israel17_clustering.pdf)
...
<u><span style="color: blue">10月17日(火)</span></u>
...
<span style="color: orange">13:30 – 15:00 -- EEGLAB(Arnaud Delorme)でスクリプトを続け...</span>
...
<span style="color: green">-- 夕食 --</span>

<u><span style="color: blue">10月18日(水)</span></u>
