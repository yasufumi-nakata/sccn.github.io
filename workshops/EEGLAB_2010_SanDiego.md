...
<span color=blue>第12回EEGLABの素材と動画
サンディエゴ・スーパーコンピューター・センターで行われたワークショップ
カリフォルニア大学サンディエゴ校(UCSD)、La Jolla、カリフォルニア、11月
17–22, 2010</span> (Neuroscience会議の続き)
サンディエゴ).
...
<span style="color:purple">[独立系コンポーネント分析(ICA)理論II(Jason Palmer)](http://sccn.ucsd.edu/eeglab/Online_EEGLAB_Workshop/EEGLAB12_ica2.html)</span><span style="color:darkred">[インタビュー](http://sccn.ucsd.edu/eeglab/Online_EEGLAB_Workshop/EEGLAB12_ica2.html) <span style="color:blue">[スライド](https://sccn.ucsd.edu/githubwiki/files/ica_methods.pdf)
<!-- -->



<span style="color:purple">[時間の頻度分解(Arnaud Delorme)](http://sccn.ucsd.edu/eeglab/Online_EEGLAB_Workshop/EEGLAB12_timefreqdecomp.html)</span>
[インタビュー](http://sccn.ucsd.edu/eeglab/Online_EEGLAB_Workshop/EEGLAB12_timefreqdecomp.html) [スライド](https://sccn.ucsd.edu/githubwiki/files/eeglab2010_ad_nov18_time_frequency_decompositions.pdf)
<!-- -->
...
<span style="color:darkred"><b>EEGLABの利用を開始</b></span>
...
<span style="color:darkred"><b>EEGLABの拡張</b></span>
...
<span style="color:darkred"><b>新しいツールと指示</b></span>
...
<span style="color:purple"> Practicum(クリスティアン・コテー)</span>
[スライド](https://sccn.ucsd.edu/githubwiki/files/eeglab_workshop_2010_bcilab_practicum.pdf)
[BCILAB 0.9ツールボックスをダウンロード](ftp://sccn.ucsd.edu/pub/bcilab/bcilab-0.9-stable.zip)
