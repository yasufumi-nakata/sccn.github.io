...
nav_order: 4
---
![第17回EEGLABワークショップのマグカップ](/assets/images/EEGLAB-mug-shot.png)
# EEGLABワークショップ

## 現在のワークショップ
- [<b>オンラインEEGLABワークショップ</b>](/workshops/Online_EEGLAB_Workshop) - オンラインビデオ、スライド、チュートリアル資料が含まれています!
- [今後のEEGLABワークショップ](/workshops/Future_workshops.html)

<h2>過去のEEGLABワークショップの一覧</h2>
