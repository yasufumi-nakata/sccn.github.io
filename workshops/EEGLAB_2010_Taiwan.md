...
nav_title: "EEGLAB 2010 Taiwan"
parent: Past workshops
grand_parent: Workshops
---
<span style="color: red">第11回 EEGLABワークショップ</span>
===
<span style="color: blue">NCTU、台湾
2010年9月8日～9月10日</span>
【中国語ワークショップ】
サイトマップhttp://esciedu.nctu.edu.tw/eeglab_workshop/)

アルバム
-----
[写真ダウンロード](https://sccn.ucsd.edu/githubwiki/files/workshop_album.zip)  
[アルバムサイト](http://esciedu.nctu.edu.tw/eeglab_workshop/ch/album/index.html)

地図と方向
-------------------

[お問い合わせ](http://guidetour.nctu.edu.tw/ch/ind_01.html)
...
<td width="600" align="center"><b>アジェンダ</b>
</td></tr>
<tr>
...
<td align="left"><b>招待講演2:</b><br>
<p>Arnaud Delorme - ICAコンポーネントの信頼性
</p>
</td></tr>
<tr>
<td align="center">11:20-11:40
</td>
<td align="left">ブレイクアウト
</td></tr>
<tr>
...
<td align="left"><b>招待講演4:</b><br>
<p>Tzyy-Ping Jung - 独立コンポーネントと持続的なタスクにおける脳図データの変調器 <a href="https://sccn.ucsd.edu/githubwiki/files/ica_and_ima.pdf" class="internal" title="ICA and IMA.pdf">(PDF)</a>
</p>
</td></tr>
<tr>
<td align="center">14:40~15:30
</td>
<td align="left"><b>招待講演5:</b><br>
<p>クラウス・グラマン(Klaus Gramann) - 自然認知のモバイル・ブレイン/ボディイメージング <a href="https://sccn.ucsd.edu/githubwiki/files/klaustalktaiwan1.pdf" class="internal" title="klaustalktaiwan1.pdf">(PDF)</a>
</p>
</td></tr>
<tr>
<td align="center">15:30~15:50
</td>
<td align="left">ティーブレイク
</td></tr>
<tr>
<td align="center">15:50~16:40
</td>
<td align="left"><b>招待講演6:</b><br>
<p>Jeng-Ren Duann - 機能的なコネクティビティは、信号の阻害を阻止して、劣った正面の皮質と予備供給モーター領域の異なる役割を解明します。
</p>
</td></tr>
<tr>
<td align="center">16:40~17:30
</td>
<td align="left">Arnaud Delorme - EEGLABの概要 <a href="https://sccn.ucsd.edu/githubwiki/files/eeglab_overview.pdf" class="internal" title="EEGLAB overview.pdf">(PDF)</a>
</td></tr></tbody></table>
...
<tr align="center">
<td style="background-color:#CCCCCC;"><b>タイムタイム</b>
</td>
<td style="background-color:#CCCCCC;" width="600" align="center"><b>アジェンダ</b>
</td></tr>
<tr>
...
<td align="left"><b>ワークショップ2:EEGLABメソッドI</b><br>
<ul><li>Arnaud Delorme - 時間の頻度分解 <a href="https://sccn.ucsd.edu/githubwiki/files/lecture_timefreq.pdf" class="internal" title="Lecture timefreq.pdf">(PDF)</a><br>
</li><li>Julie Onton - EEGLABの基本的なスクリプトの履歴を使用する <a href="https://sccn.ucsd.edu/githubwiki/files/4_basic_scripting.pdf" class="internal" title="4 Basic Scripting.pdf">(PDF)</a>
</li></ul>
</td></tr>
<tr>
...
<td align="left">グループ研究
</td></tr></tbody></table>
<table border="1" width="800">
<tbody><tr>
<th colspan="6">9月10日(金)
</th></tr>
<tr align="center">
<td style="background-color:#CCCCCC;"><b>タイムタイム</b>
</td>
...
<td align="left">グループ研究継続
</td></tr>
<tr>
<td align="center">17:00~18:00
</td>
<td>グループ研究報告とディスカッション
</td></tr></tbody></table>

MATLABおよびマトリックスの導入の読書材料
-----------------------------------------------
...
時間の制約により、導入はいたしません。
MATLAB言語。 代わりに、ユーザーは自分自身に精通する必要があります
ワークショップ前のMATLAB。 MATLAB 7のユーザー: 実行をお勧め
以下のデモを読んで、次のヘルプセクションを読んでください。

MATLABデスクトップを開くと、メニュー項目「ヘルプデモ」を選択し、実行します。
次のデモ。 デモが実行されている間、再入力できます
テキスト(またはコピー)をメインのMATLABウィンドウへ:
- 数学 - 基本的なマトリックス操作
- 数学 - マトリックス操作
- グラフィック - 2 D プロット
- プログラミング - 多次元配列の操作
...
Help コンテンツで、以下のセクションを読んで練習します。
- スタート - マトリクスとアレイ - マトリクスとマジックスクエア
- スタート - マトリックスと配列 - 表現
- スタート - マトリクスとアレイ - マトリクスで作業
- 始める - グラフィックス - 基本的なプロット機能
- プログラミング入門 - フロー制御
- スタート - プログラミング - その他のデータ構造
- プログラミング入門 - スクリプトと関数

各セクションまたはデモ(徹底的に読む場合)は、約10を取る必要があります
所要時間約2時間。 皆様のお越しをお待ちしております。
これらのデモは数日間にわたってこれらのセクションを読みます。

**重要な注意:** ワークショップの大きな部分は、
EEGLABスクリプトを書くので、MATLABの構文を理解できない
ワークショップの大きな部分に欠けている結果になります。

ICA/EEGLABによる関連する出版物
--------------------------------------
...
- Onton J, Makeig S. [高周波ブロードバンドの変調]
    電気脳卒
    スペックトラ>(http://www.frontiersin.org/human_neuroscience/10.3389/neuro.09/061.2009/abstract).
    神経科学のフロンティア 159:99-120. 2009.
- Onton J, Makeig S. [イベント関連情報に基づくモデリング]
    脳アーキテクチャ
    ダイナミクス(ftp://sccn.ucsd.edu/pub/julie/Onton_PBR_published.pdf) プログ
    脳解像度. 159:99-120. 2006.
...
[チュートリアルスクリプト](https://sccn.ucsd.edu/githubwiki/files/scripts.zip) スクリプトをダウンロード
スクリプトコンポーネントを使用して特定のチュートリアルセッション。
...
[NFT:神経電磁気] フォワードヘッドモデリングツールボックス(11)
