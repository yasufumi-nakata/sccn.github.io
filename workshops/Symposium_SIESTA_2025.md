...
プログラム
--------
10月10日 **Isabelle Berry ** オープニングステートメント

10:05 -- **ロバート・オオステンド** SIESTAプロジェクトのご紹介

10:20～ **Cyril Pernet ** -- データのプライバシーと情報プライバシーを神経イメージングに

11:00～11:00 **Marcel Zwiers** -- 合成および匿名の神経イメージングデータを作成するBIDScramble

11:20～ **Adrien Marque ** SIESTAフレームワークのfMRIパイプラインの例
...
1:50～ **Scott Makeig ** クラウドコンピューティングソリューションのための階層イベント記述子

2:10 - **Jan-Mathijs Schoffelen ** 再現可能なSIESTAパイプラインを実装するためのヒントとコツ
